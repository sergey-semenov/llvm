...
void testInvalidCompileTimeProperty(sycl::queue &q) {
  ...
  TEST(malloc_device_annotated, N, q, properties{alignment<8>, bar})
  ...
  TEST(malloc_device_annotated, N, dev, Ctx, properties{alignment<8>, baz<5>})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}baz_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(malloc_device_annotated<int>, N, q, properties{alignment<8>, baz<2>})
  ...
  TEST(malloc_device_annotated<int>, N, dev, Ctx, properties{alignment<8>, device_has<sycl::aspect::cpu>})
  ...
  TEST(aligned_alloc_device_annotated, 1, N, q, properties{alignment<8>, work_group_size<1>})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}baz_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(aligned_alloc_device_annotated, 1, N, dev, Ctx, properties{alignment<8>, baz<3>})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}baz_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(aligned_alloc_device_annotated<int>, 1, N, q, properties{alignment<8>, baz<0>})
  ...
  TEST(aligned_alloc_device_annotated<int>, 1, N, dev, Ctx, properties{alignment<8>, boo<void>})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}boo_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(malloc_host_annotated, N, q, properties{alignment<8>, boo<int>})
  ...
  TEST(malloc_host_annotated, N, Ctx, properties{alignment<8>, streaming_interface_accept_downstream_stall})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}boo_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(malloc_host_annotated<int>, N, Ctx, properties{alignment<8>, boo<int, int>})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}boo_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(aligned_alloc_host_annotated, 1, N, q, properties{alignment<8>, boo<int, bool>})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}boo_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(aligned_alloc_host_annotated, 1, N, Ctx, properties{alignment<8>, boo<int, int, int>})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}boo_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(aligned_alloc_host_annotated<int>, 1, N, q, properties{alignment<8>, boo<bool>})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}boo_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(aligned_alloc_host_annotated<int>, 1, N, Ctx, properties{alignment<8>, boo<float>})
  ...
  TEST(malloc_shared_annotated, N, q, properties{alignment<8>, device_image_scope})
  ...
  TEST(malloc_shared_annotated, N, dev, Ctx, properties{alignment<8>, host_access_read})

  // expected-error-re@sycl/ext/oneapi/experimental/annotated_usm/alloc_util.hpp:* {{static assertion failed due to requirement {{.+}}boo_key{{.+}}: Found invalid compile-time property in the property list.}}
  TEST(malloc_shared_annotated<int>, N, q, properties{boo<char>, alignment<8>})
  ...
  TEST(malloc_shared_annotated<int>, N, dev, Ctx, properties{alignment<8>, init_mode_reset})
  ...
  TEST(aligned_alloc_shared_annotated, 1, N, q, properties{alignment<8>, implement_in_csr_on})
  ...
  TEST(aligned_alloc_shared_annotated, 1, N, dev, Ctx, properties{alignment<8>, ready_latency<1>})
  ...
  TEST(aligned_alloc_shared_annotated<int>, 1, N, q, properties{alignment<8>, bits_per_symbol<1>})
  ...
  TEST(aligned_alloc_shared_annotated<int>, 1, N, dev, Ctx, properties{alignment<8>, pipelined<1>})
  ...
  TEST(malloc_annotated, N, q, alloc::device, properties{alignment<8>, sub_group_size<2>})
  ...
  TEST(malloc_annotated, N, dev, Ctx, alloc::device, properties{alignment<8>, uses_valid_on})
  ...
  TEST(malloc_annotated<int>, N, dev, Ctx, alloc::device, properties{alignment<8>, protocol_avalon_streaming_uses_ready})
  ...
  TEST(aligned_alloc_annotated, 1, N, q, alloc::device, properties{alignment<8>, word_size<1>})
  ...
  TEST(aligned_alloc_annotated, 1, N, dev, Ctx, alloc::device, properties{alignment<8>, stride_size<1>})
  ...
  TEST(aligned_alloc_annotated<int>, 1, N, q, alloc::device, properties{alignment<8>, work_group_size_hint<1>})
  ...
  TEST(aligned_alloc_annotated<int>, 1, N, dev, Ctx, alloc::device, properties{alignment<8>, latency_anchor_id<5>})
}
